...
* Defaults to single-path, can show all paths
* Will work across any paths less than 20 hops per segment, O(n) complexity
* TODO: Add optional configuration snippets for each hop
...
### Example 2: L2 -> L3 -> L2: All Paths between two devices on the same Switch, different VLAN
```
$ ./netgrph.py -p 10.26.72.142 10.28.7.137 -allpaths
┌─[ PATHs L2-L4 ]
│
...
│   ├── Traversal Type : All Paths
│   │
│   ├───┬─[ L2-HOP #1 art7t1sw1(Te5/1) -> artmdf1(Eth1/8) ]
│   │   ├── From Channel : 1
│   │   ├── From Port : Te5/1
...
│   │   └── distance : 1
│   │
│   └───┬─[ L2-HOP #1 art7t1sw1(Te6/1) -> artmdf2(Eth1/8) ]
│       ├── From Channel : 1
│       ├── From Port : Te6/1
│       ├── From Switch : art7t1sw1
│       ├── Link VLANs : 1-1005
...
│   ├── Traversal Type : All Paths
│   │
│   ├───┬─[ L2-HOP #1 artmdf1(Eth1/8) -> art7t1sw1(Te5/1) ]
│   │   ├── From Channel : 108
│   │   ├── From Port : Eth1/8
│   │   ├── From Switch : artmdf1
│   │   ├── Link VLANs : 1-1005
...
│   │   └── distance : 1
│   │
│   └───┬─[ L2-HOP #1 artmdf2(Eth1/8) -> art7t1sw1(Te6/1) ]
│       ├── From Channel : 108
│       ├── From Port : Eth1/8
│       ├── From Switch : artmdf2
│       ├── Link VLANs : 1-1005
...
## Example 3: L2 -> L3 -> L4 -> L3 -> L2: Single Path between two devices on the same Switch, different VRF
```
...
│   ├── VRF : default
│   │
│   └───┬─[ L3-HOP #1 artmdf1(10.23.74.11) -> core1(10.23.74.10) ]
│       ├── From IP : 10.23.74.11
│       ├── From Router : artmdf1
│       ├── To IP : 10.23.74.10
│       ├── To Router : core1
...
│   ├── VRF : utility
│   │
│   └───┬─[ L3-HOP #1 core1(10.23.74.10) -> artmdf1(10.23.74.11) ]
│       ├── From IP : 10.23.74.10
│       ├── From Router : core1
│       ├── To IP : 10.23.74.11
│       ├── To Router : artmdf1
